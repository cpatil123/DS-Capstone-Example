...
WordLineChar.df <- data.frame('Raw Size (MB)' = c(blogs.size, news.size, twitter.size), 'Lines' = c(Blogs.Lines, News.Lines, Twitter.Lines), 'Words' = c(0, 0, 0), 'Characters' = c(CharLengthOfBlogsText, CharLengthOfNewsText,  CharLengthOfTwitterText), row.names = c('Blogs', 'News', 'Twitter'))
colnames(WordLineChar.df) <- c("Size (MB)", "Line Count", "Word Count", "Character Count")
...
s.WordLineChar.df <- data.frame('Sample Size (MB)' = c(s.blogs.size, s.news.size, s.twitter.size), 'Lines' = c(s.Blogs.Lines, s.News.Lines, s.Twitter.Lines), 'Words' = c(0, 0, 0), 'Characters' = c(s.CharLengthOfBlogsText, s.CharLengthOfNewsText,  s.CharLengthOfTwitterText), row.names = c('Blogs', 'News', 'Twitter'))
colnames(s.WordLineChar.df) <- c("Sample Size (MB)", "Line Count", "Word Count", "Character Count")
```
